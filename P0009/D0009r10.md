...
>  _Make the following changes to 22.7.1 **[views.general]**_,
...
>  _Add the following subclauses to the end of the **[views]** subclause
(after `span`):_
...
-->
<br/>
<b>22.7.�.1 `basic_mdspan` constructors, assignment, and destructor [mdspan.basic.cons]</b>
...
<br/>
<b>22.7.�.2 `basic_mdspan` mapping domain multidimensional index to access codomain element [mdspan.basic.mapping]</b>
...
-->
<br/>
<b>22.7.�.3 `basic_mdspan` observers of the domain multidimensional index space [mdspan.basic.domobs]</b>
...
<br/>
<b>22.7.�.3 `basic_mdspan` observers of the codomain [mdspan.basic.codomain]</b>
