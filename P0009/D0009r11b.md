...
### D00009r11a (NLIBER WILL REMOVE THIS HEADING)
...
### D0009r11b (NLIBER WILL REMOVE THIS HEADING)
...
### Discussed changes not made (and why) (NLIBER WILL REMOVE THIS SECTION)
- Did not default comparisons, as the only types in the standard which do
  that have their members fully specified (not just exposition-only).
- Other than renaming IndexType to SizeTypes, didn't use auto...
  as it was already correct (the lack of pluralness threw us off)

### Changes I made we didn't discuss: (NLIBER WILL REMOVE THIS SECTION)
- Made size_type in layout_* non-exposition because it is returned

### TODO (NLIBER WILL REMOVE THIS SECTION, IF EMPTY)

### Open issues (NLIBER WILL REMOVE THIS SECTION, IF EMPTY)
