...
WA: "new CTAD for mdspan didn't cover impact of change on the non-type, non-extents arguments.  Discussing this in the paper could mitigate this concern."
...
[The header `<mdspan>` defines the view `mdspan`
and other facilities for interacting with these views.]{.add}
