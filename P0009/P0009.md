...
public:
  ...
  template<class OtherSizeType>
    requires(!is_integral_v<OtherSizeType>)
    static constexpr size_type @_index-cast_@(const OtherSizeType& i) noexcept { return static_cast<size_type>(i); } // @_exposition only_@
  template<class IntegralType>
    requires(is_integral_v<IntegralType>)
    static constexpr IntegralType @_index-cast_@(const IntegralType& i) noexcept { return i; } // @_exposition only_@
