...
public:
  ...
  static constexpr auto @_index-cast_@(const OtherSizeType&) noexcept; // @_exposition only_@
...
```c++
  template<class OtherSizeType>
  static constexpr auto @_index-cast_@(const OtherSizeType& i) noexcept; // @_exposition only_@
```
