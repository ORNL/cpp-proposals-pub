...
[1]{.pnum} An *accessor policy* defines types and operations by which a reference to a single object is produced from an abstract data handle to a number of such objects and an index.
