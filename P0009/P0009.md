...
[1]{.pnum} `mdspan` is a view of an multidimensional array of elements. 
...
[2]{.pnum} *Mandates:*
   ...
   * [2.1]{.pnum} `ElementType` is a a complete object type that is neither an abstrct class type nor an array type,
