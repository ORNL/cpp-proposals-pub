...
<font color="blue">The class template `extents` stores multiple extents.
This defines a multi-dimensional index space where the number of extents stored is the <i>rank</i>. </font>
