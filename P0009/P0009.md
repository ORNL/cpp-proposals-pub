...
- Fix `mdspan` CArray and Pointer deduction guides so they work with non-lvalues
...
requires(is_array_v<remove_reference_t<CArray>> &&
         rank_v<remove_reference_t<CArray>> == 1)
mdspan(CArray&&)
  -> mdspan<remove_all_extents_t<remove_reference_t<CArray>>, extents<size_t, extent_v<remove_reference_t<CArray>, 0>>>
