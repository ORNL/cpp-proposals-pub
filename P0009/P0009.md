...
[9]{.pnum} *Returns:* _fwd-prod-of-extents_`(extents(),extents_type::rank())`.
...
[15]{.pnum} *Returns:*  _fwd-prod-of-extents_`(extents(), i)`.
...
[14]{.pnum} *Returns:*  _rev-prod-of-extents_`(extents(), i+1)`
...
[10]{.pnum} *Returns:*
   ...
   * [10.2]{.pnum} `0`, if _fwd-prod-of-extents_`(extents(), extents_type::rank()-1)==0` is `true`, otherwise
