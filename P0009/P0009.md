...
[1]{.pnum} Each of `layout_left`, `layout_right`, and `layout_stride` meet the layout mapping policy requirements and is a trivially copyable type.
...
class layout_stride::mapping {
  ...
  public:
    ...
    constexpr const extents_type& extents() const noexcept { return @_extents\__@; }
    constexpr const array<size_type, rank>& strides() const noexcept
    { return @_strides\__@; }
