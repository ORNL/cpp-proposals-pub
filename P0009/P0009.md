...
[5]{.pnum} *Constraints:*
   ...
   * [5.3]{.pnum} `bool(StridedLayoutMapping::is_always_unique())` is `true`.

   * [5.4]{.pnum} `bool(StridedLayoutMapping::is_always_strided())` is `true`.
...
[7]{.pnum} *Constraints:* 
   ...
   * [7.3]{.pnum} `bool(OtherMapping::is_always_strided())` is `true`.
