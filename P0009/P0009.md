...
public:
  ...
  template<class SizeType>
    requires(!is_integral_v<SizeType>)
    static constexpr size_type @_index-cast_@(const SizeType& i) noexcept { return static_cast<size_type>(i); } // @_exposition only_@
...
[3]{.pnum} *Preconditions:* `extents_type::`_`index-cast`_`(i)` is a multidimensional index in $extents\_$ ([mdspan.terms]).
