...
[9]{.pnum} *Constraints:*
   ...
   * [9.1]{.pnum} `is_convertible_v<const remove_const_t<OtherSizeType>&, size_type>` is `true`, and

   * [9.2]{.pnum} `is_nothrow_constructible_v<size_type, const remove_const_t<OtherSizeType>&>` is `true`, and
