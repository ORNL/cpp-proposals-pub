...
concept @_layout-mapping-alike_@ = requires {
  @_is-extents_@<typename M::extents_type>::value;
  integral_constant<typename M::extents_type::rank_type, M::extents_type::rank()>::value;
  bool_constant<M::is_always_strided()>::value;
  bool_constant<M::is_always_contiguous()>::value;
  bool_constant<M::is_always_unique()>::value;
  is_same_v<decltype(M::is_always_strided()), bool>;
  is_same_v<decltype(M::is_always_contiguous()), bool>;
  is_same_v<decltype(M::is_always_unique()), bool>;
};
```
...
[7]{.pnum} *Constraints:* 
   ...
   * [7.1]{.pnum} _`layout-mapping-alike`_`<StridedLayoutMapping>` is satisfied.
