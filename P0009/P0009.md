...
class layout_right::mapping {
  public:
    ...
    template<class OtherExtents>
      explicit(extents_type::rank() > 0) constexpr mapping(
      const layout_stride::mapping<OtherExtents>&) noexcept;
