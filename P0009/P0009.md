...
[4]{.pnum} *Effects:* Direct-non-list-initializes _`extents_`_ with `other.extents()`.
...
[6]{.pnum} *Effects:* Direct-non-list-initializes _`extents_`_ with `other.extents()`.
...
[9]{.pnum} *Effects:* Direct-non-list-initializes _`extents_`_ with `other.extents()`.
