...
[31]{.pnum} *Effects:*
   ...
   * [32.2]{.pnum} Direct-non-list-initializes `ctr_` with `std::move(c)`.
...
[33]{.pnum} *Constraints:* 
   ...
   * [3.2]{.pnum} `is_constructible_v<container_type, OtherContainer>` is `true`.
...
[5]{.pnum} *Preconditions:* 
   ...
   * [5.3]{.pnum} `map.required_span_size() >= size(container_type(map.required_span_size(), a))` is `true`.
...
[8]{.pnum} *Preconditions:* 
   ...
   * [8.2]{.pnum} `map.required_span_size() >= size(container_type(map.required_span_size(), a))` is `true`.

[4]{.pnum} *Effects:*

   * [4.1]{.pnum} Direct-non-list-initializes _`map_`_ with `map`, and

   * [4.2]{.pnum} Direct-non-list-initializes `ctr_` with `map.required_span_size()` as the first argument and `a` as the second argument.
...
[5]{.pnum} *Preconditions:* 
   ...
   * [5.3]{.pnum} `map.required_span_size() >= size(container_type(map.required_span_size(), val, a))` is `true`.
...
[8]{.pnum} *Preconditions:* 
   ...
   * [8.2]{.pnum} `map.required_span_size() >= size(container_type(map.required_span_size(), val, a))` is `true`.
