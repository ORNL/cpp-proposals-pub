...
\begin{addedblock}
\pnum
The template parameter \tcode{LockT} shall either:
\begin{itemize}
...
\end{itemize}
Dianostics required if \tcode{LockT} is equivalent to \tcode{atomic_ref_assume_lock_free_t} 
...
operations for objects of type \tcode{T} aligned to \tcode{required_lock_free_alignment}.
