...
# Revision history
  ...
  * Revision 12 to be submitted 2023/03/15
    ...
    * Add section *[linalg.general]* ("General") that explains
        ...
        that calls to `abs`, `conj`, `imag`, and `real` are unqualified.
        Move the definitions of lower triangle, upper triangle, and diagonal
...
[3]{.pnum} For any function `F` that takes a `Triangle t` parameter,
`t` applies to accesses to the previous parameter to the function.
...
[3]{.pnum} Within all the functions in **[linalg]**,
