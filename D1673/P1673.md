...
### Conjugate transpose transform [linalg.conjtransposed]
...
#### Rank-k update of a symmetric or Hermitian matrix [linalg.alg.blas3.rankk]

##### Complexity [linalg.alg.blas3.rankk.complexity]
...
[1]{.pnum} *Complexity:*
All algorithms in [linalg.alg.blas3.rankk] with `mdspan` parameters
perform a count of `mdspan` array accesses
and arithmetic operations that is linear in
`A.extent(0)` times `A.extent(1)` times `A.extent(0)`.

##### Rank-k symmetric matrix update [linalg.alg.blas3.rankk.syrk]
...
##### Rank-k Hermitian matrix update [linalg.alg.blas3.rankk.herk]
