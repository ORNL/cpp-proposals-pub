...
// [linalg.helpers.abs], exposition-only function object @_abs-if-needed_@
/* @_see-below_@ */ @_abs-if-needed_@; // @_exposition only_@

// [linalg.helpers.conj], exposition-only function object @_conj-if-needed_@
/* @_see-below_@ */ @_conj-if-needed_@; // @_exposition only_@

// [linalg.helpers.real], exposition-only function object @_real-if-needed_@
/* @_see-below_@ */ @_real-if-needed_@; // @_exposition only_@

// [linalg.helpers.imag], exposition-only function object @_imag-if-needed_@
/* @_see-below_@ */ @_imag-if-needed_@; // @_exposition only_@
...
// exposition-only helpers for algorithm mandates
...
// exposition-only checks for algorithm preconditions
...
#### Class template `layout_transpose` [linalg.transp.layout_transpose]
