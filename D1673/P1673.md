...
[13]{.pnum} *Preconditions:* `extents_type::`_`index-cast`_`(ind0, ind1)`
...
[4]{.pnum} *Mandates:*
  ...
  * [4.1]{.pnum} `InputExtents` is a specialization of `extents`, and

  * [4.2]{.pnum} `InputExtents::rank()` equals 2.
