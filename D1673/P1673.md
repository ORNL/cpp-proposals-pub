...
// [linalg.conj.conjugated_accessor], class template conjugated_accessor
...
#### Class template `conjugated_accessor` [linalg.conj.conjugated_accessor]
...
public:
  ...
  constexpr conjugated_accessor(const scaled_accessor&) = default;
...
[1]{.pnum} *Returns:*
  ...
  * [2.1]{.pnum} `mdspan(a.data_handle(), a.mapping(), a.accessor().nested_accessor())` if `Accessor` is a specialization of `conjugated_accessor`; otherwise

  * [2.2]{.pnum} `mdspan(a.data_handle(), a.mapping(), conjugated_accessor(a.accessor()))`.
