...
triangular_matrix_vector_solve(A, t, d, b, x,
  [](const auto& b_i, const auto& A_ii) { return b_i / A_ii; });
```
...
triangular_matrix_matrix_left_solve(A, t, d, B, X,
  [](const auto& X_elt, const auto& A_elt) { return X_elt / A_elt; });
```
...
triangular_matrix_matrix_left_solve(A, t, d, B,
  [](const auto& B_elt, const auto& A_elt) { return B_elt / A_elt; });
```
