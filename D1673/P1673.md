...
public:
  ...
  public:
    ...
    constexpr bool is_unique() const
      noexcept(noexcept(@_nested-mapping\__@.is_unique()))
      { return @_nested-mapping\__@.is_unique(); }
    constexpr bool is_exhaustive() const
      noexcept(noexcept(@_nested-mapping\__@.is_exhaustive()))
      { return @_nested-mapping\__@.is_exhaustive(); }
    constexpr bool is_strided() const
      noexcept(noexcept(@_nested-mapping\__@.is_strided()))
      { return @_nested-mapping\__@.is_strided(); }

    constexpr index_type stride(size_t r) const
      noexcept(noexcept(@_nested-mapping\__@.stride(r)));

    template<class OtherExtents>
      friend constexpr bool
        operator==(const mapping& x, const mapping<OtherExtents>& y)
          noexcept(noexcept(x.@_nested-mapping\__@ == y.@_nested-mapping\__@));
  };
