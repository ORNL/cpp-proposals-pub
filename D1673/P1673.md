...
template<class T>
struct @_is-mdspan_@; // @_exposition only_@
...
[4]{.pnum} *Mandates:*
  ...
  * [4.6]{.pnum} if `Extents::rank_dynamic() == 0` is `true`,
      ...
      as a value of type `typename Extents::index_type`.
...
```c++
template<class T>
struct @_is-mdspan_@ : false_type {}; // @_exposition only_@

template<class ElementType, class Extents, class Layout, class Accessor>
struct @_is-mdspan_@<mdspan<ElementType, Extents, Layout, Accessor>> : true_type {}; // @_exposition only_@
