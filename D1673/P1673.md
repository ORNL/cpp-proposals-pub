...
[5]{.pnum} These functions perform a matrix-matrix multiply, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
...
[10]{.pnum} These functions perform a matrix-matrix multiply, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
...
[15]{.pnum} These functions perform a potentially overwriting matrix-matrix multiply-add, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
`A` is the symmetric, Hermitian, or triangular matrix respectively.
...
[21]{.pnum} These functions perform a potentially overwriting matrix-matrix multiply-add, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
`B` is the symmetric, Hermitian, or triangular matrix respectively.
...
[1]{.pnum} These functions perform an in-place matrix-matrix multiply, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
...
[1]{.pnum} These functions perform multiple matrix solves, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
`A` is the triangular matrix.
...
[9]{.pnum} These functions perform multiple matrix solves, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
`A` is the triangular matrix.
...
[1]{.pnum} These functions perform multiple in-place matrix solves, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
`A` is the triangular matrix.
...
[9]{.pnum} These functions perform multiple in-place matrix solves, taking into account the `Triangle` and `DiagonalStorage` parameters where applicable [linalg.general].
`A` is the triangular matrix.
