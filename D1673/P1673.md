...
[5]{.pnum} This function performs an overwriting symmetric matrix-vector product,
...
[7]{.pnum} This function performs an updating symmetric matrix-vector product,
taking into account the `Triangle` parameter
that applies to the symmetric matrix `A` [linalg.general].
...
[5]{.pnum} This function performs an overwriting Hermitian matrix-vector product,
taking into account the `Triangle` parameter
...
[7]{.pnum} This function performs an updating Hermitian matrix-vector product,
taking into account the `Triangle` parameter
that applies to the Hermitian matrix `A` [linalg.general].
