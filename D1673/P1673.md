...
[2]{.pnum} *Mandates:*
  ...
  * [2.5]{.pnum} `is_constructible_v<element_type, decltype(declval<ScalingFactor>() * element_type)>` is `true`.
...
[5]{.pnum} *Returns:* `scaling_factor() * element_type(` _`nested-accessor`_`.access(p, i))`
