...
# Revision history
  ...
  * Revision 13 - running revision for LWG review
    ...
    * Make sure that Complexity clauses use the math multiplication symbol
        instead of code-font multiplication.
...
[4]{.pnum} *Complexity:* $O($ `x.extent(0)` $\times$ `A.extent(1)` $)$
...
[6]{.pnum} *Complexity:* $O($ `x.extent(0)` $\times$ `A.extent(1)` $)$
...
[9]{.pnum} *Complexity:* $O($ `y.extent(0)` $\times$ `A.extent(1)` $)$
...
[13]{.pnum} *Complexity:* $O($ `x.extent(0)` $\times$ `A.extent(1)` $)$
...
[6]{.pnum} *Complexity:* $O($ `A.extent(1)` $\times$ `b.extent(0)` $)$
...
[11]{.pnum} *Complexity:* $O($ `A.extent(1)` $\times$ `b.extent(0)` $)$
...
[5]{.pnum} *Complexity:* $O($ `x.extent(0)` $\times$ `y.extent(0)` $)$
...
[4]{.pnum} *Complexity:* $O($ `x.extent(0)` $\times$ `x.extent(0)` $)$
...
[4]{.pnum} *Complexity:* $O($ `x.extent(0)` $\times$ `y.extent(0)` $)$
...
[4]{.pnum} *Complexity:* $O($ `A.extent(0)` $\times$ `A.extent(1)` $\times$ `B.extent(1)` $)$
...
[5]{.pnum} *Complexity:* $O($ `A.extent(0)` $\times$ `A.extent(1)` $\times$ `C.extent(0)` $)$
...
[9]{.pnum} *Complexity:* $O($ `A.extent(0)` $\times$ `A.extent(1)` $\times$ `C.extent(0)` $)$
...
[4]{.pnum} *Complexity:* $O($ `A.extent(0)` $\times$ `A.extent(1)` $\times$ `C.extent(0)` $)$
...
[5]{.pnum} *Complexity:* $O($ `A.extent(0)` $\times$ `X.extent(1)` $\times$ `X.extent(1)` $)$
...
[12]{.pnum} *Complexity:* $O($ `B.extent(0)` $\times$ `B.extent(1)` $\times$ `A.extent(1)` $)$
...
[5]{.pnum} *Complexity:* $O($ `A.extent(0)` $\times$ `A.extent(1)` $\times$ `B.extent(1)` $)$
...
[12]{.pnum} *Complexity:* $O($ `A.extent(0)` $\times$ `A.extent(1)` $\times$ `B.extent(1)` $)$
