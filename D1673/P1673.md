...
// [linalg.layouts.packed.cons], constructors
...
// [linalg.layouts.packed.obs], observers
...
[4]{.pnum} *Mandates:*
  ...
  * [4.5]{.pnum} one of `extents_type::static_extent(0) == dynamic_extent`,
                  ...
                  `extents_type::static_extent(r1) == extents_type::static_extent(1))` is `true`, and

  * [4.6]{.pnum} if `Extents​::​rank_dynamic() == 0` is true, then the size of the multidimensional index space `Extents()` is representable as a value of type `typename Extents​::​index_type`.
