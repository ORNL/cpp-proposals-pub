...
## In Subsection 22.7.X.5.2 [mdspan.layoutstride.ctor]

* add to paragraph 5 (*Preconditions* element of `mapping(const StridedLayoutMapping& other)` constructor), after 5.1 and before 5.2, an additional precondition:
